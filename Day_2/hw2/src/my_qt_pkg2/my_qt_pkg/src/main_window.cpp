...
// pose 구독 콜백: 현재 위치를 계속 최신 상태로 저장
...
// 기록 시작: 이전 기록 초기화 후 0.1초 간격 샘플링 시작
...
// 0.1초마다 호출됨: 현재 위치를 기록하고 이동거리 누적
...
// 재생: 저장된 좌표를 순서대로 teleport_absolute로 재현
void MainWindow::on_play_btn_clicked()
{
    ...
    play_timer_->start(100); // 기록 때와 같은 간격으로 재현
}

// 0.1초마다 호출됨: 다음 저장된 좌표로 순간이동
